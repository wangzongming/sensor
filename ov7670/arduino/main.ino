// 参见教程 https://circuitdigest.com/microcontroller-projects/how-to-use-ov7670-camera-module-with-arduino
#include <stdint.h>
#include <avr/io.h>
#include <util/twi.h>
...
void setup(){
  ...
  setColor();
  // 值越小拍照越快
  // 这使用 CLKRC 寄存器将 PCLK 预分频器设置为 32，即。PCLK 频率变得比 XCLK 慢 32 倍。
//  writeReg(0x11, 31); //Earlier it had the value:writeReg(0x11, 12); New version works better for me :) !!!!
 writeReg(0x11, 6); //Earlier it had the value:writeReg(0x11, 12); New version works better for me :) !!!!
}
